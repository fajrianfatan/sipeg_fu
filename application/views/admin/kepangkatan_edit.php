						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<?php echo form_open_multipart('admin/kepangkatan/AksiEdit')?>
									<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="pkt" name="tgl_sk_pangkat" class="date-picker form-control" value="<?php echo $kepangkatan->tgl_sk_pangkat?>" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)">
												<script>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="tmtpkt" name="tmt_sk_pangkat" class="date-picker form-control" value="<?php echo $kepangkatan->tmt_sk_pangkat?>" required="required" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)">
												<script>
													function timeFunctionLong(input) {
														setTimeout(function() {
															input.type = 'text';
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												<a href="<?php echo base_url('admin/kepangkatan')?>"><button class="btn btn-primary" type="button">Cancel</button></a>
