								...
								<div class="x_content">
									...
									<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="id_pegawai" class="form-control " value="<?php echo $pegawai->id_pegawai ?>" readonly>
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name="jenis_kelamin" required="required" type="text">
													...
													<option value="<?php echo $jk->jenis_kelamin ?>" <?= $jk->jenis_kelamin == $pegawai->jenis_kelamin ? "selected" : null ?>><?php echo $jk->jenis_kelamin; ?></option>
													<?php endforeach; ?>
												</select>
											</div>
										</div>
										<div class="item form-group">
											<label for="email" class="col-form-label col-md-3 col-sm-3 label-align"> Username Akun </label>
											<div class="col-md-6 col-sm-6 ">
												<input required="required" name="username" class="form-control" type="text" value="<?php echo $pegawai->username ?>">
											</div>
										</div>
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align">Foto Pegawai</label><br>
											<div class="col-md-6 col-sm-6 ">
												<img width="200px" src="<?php echo base_url().'assets/directory/foto pegawai/'.$pegawai->foto_pegawai ?> ">
												<br>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name="agama" required="required" type="text">
													...
													<option value="<?php echo $agama->agama ?>" <?= $agama->agama == $pegawai->agama ? "selected" : null ?>><?php echo $agama->agama; ?></option>
													<?php endforeach; ?>
												</select>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name="pendidikan" required="required" type="text">
													...
													<option value="<?php echo $pend->pendidikan ?>" <?= $pend->pendidikan == $pegawai->pendidikan ? "selected" : null ?>><?php echo $pend->pendidikan; ?></option>
													<?php endforeach; ?>
												</select>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name="status_nikah" required="required" type="text">
													...
													<option value="<?php echo $nikah->status_menikah ?>" <?= $nikah->status_menikah == $pegawai->status_nikah ? "selected" : null ?>><?php echo $nikah->status_menikah; ?></option>
													<?php endforeach; ?>
												</select>
											</div>
										</div>
										...
										<div class="item form-group">
											<label for="email" class="col-form-label col-md-3 col-sm-3 label-align">Kelurahan/Desa</label>
											<div class="col-md-6 col-sm-6 ">
												<input name="kelurahan" class="form-control" type="text" value="<?php echo $pegawai->kelurahan ?>">
											</div>
										</div>
										<div class="item form-group">
											<label for="email" class="col-form-label col-md-3 col-sm-3 label-align">Kecamatan</label>
											<div class="col-md-6 col-sm-6 ">
												<input name="kecamatan" class="form-control" type="text" value="<?php echo $pegawai->kecamatan ?>">
											</div>
										</div>
										<div class="item form-group">
											<label for="email" class="col-form-label col-md-3 col-sm-3 label-align">Kota/Kabupaten</label>
											<div class="col-md-6 col-sm-6 ">
												<input name="kota" class="form-control" type="text" value="<?php echo $pegawai->kota ?>">
											</div>
										</div>
										<div class="item form-group">
											<label for="email" class="col-form-label col-md-3 col-sm-3 label-align">Provinsi</label>
											<div class="col-md-6 col-sm-6 ">
												<input name="provinsi" class="form-control" type="text" value="<?php echo $pegawai->provinsi ?>">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="birthday" name="tanggal_lahir" class="date-picker form-control" value="<?php echo $pegawai->tanggal_lahir ?>" required="required" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)">
												<script>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name="jenis_pegawai" required="required" type="text">
													...
													<option value="<?php echo $jenis->jenis_pegawai ?>" <?= $jenis->jenis_pegawai == $pegawai->jenis_pegawai ? "selected" : null ?>><?php echo $jenis->jenis_pegawai; ?></option>
													<?php endforeach; ?>
												</select>
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name="jabatan" required="required" type="text">
													...
													<option value="<?php echo $jbtn->jabatan ?>" <?= $jbtn->jabatan == $pegawai->jabatan ? "selected" : null ?>><?php echo $jbtn->jabatan; ?></option>
													<?php endforeach; ?>
												</select>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name="gol_ruang" required="required" type="text">
													...
													<option value="<?php echo $gol->gol_ruang ?>" <?= $gol->gol_ruang == $pegawai->gol_ruang ? "selected" : null ?>><?php echo $gol->gol_ruang; ?></option>
													<?php endforeach; ?>
												</select>
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name="pangkat" required="required" type="text">
													...
													<option value="<?php echo $pkt->pangkat ?>" <?= $pkt->pangkat == $pegawai->pangkat ? "selected" : null ?>><?php echo $pkt->pangkat; ?></option>
													<?php endforeach; ?>
												</select>
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name="jurusan" required="required" type="text">
													...
													<option value="<?php echo $jrs->jurusan ?>" <?= $jrs->jurusan == $pegawai->jurusan ? "selected" : null ?>><?php echo $jrs->jurusan; ?></option>
													<?php endforeach; ?>
												</select>
											</div>
										</div>
