						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form method="post" action="<?php echo base_url('admin/tbl_jurusan/AksiEdit')?>">
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align">ID JURUSAN
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="id_jurusan" class="form-control " value="<?php echo $jurusan->id_jurusan ?>" readonly>
											</div>
										</div>
										<div class="item form-group">
