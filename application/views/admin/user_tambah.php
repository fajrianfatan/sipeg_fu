					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								Masukkan data user/hak akses baru. Untuk menghindari error/gagal saat menambah data user baru, silakan unggah foto user dengan ukuran maksimal 2 MB dan resolusi 600x400 pixel.
								</p>
									<br />
									<?php echo form_open_multipart('admin/user/input_aksi')?>
                                        <div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align">ID USER
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="id_user" class="form-control " placeholder="Kolom ini akan terisi otomatis" disabled>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="nama_user" required="required" class="form-control " placeholder="dosenfu123">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="username" required="required" class="form-control " placeholder="dosenfu123">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											<label  class="col-form-label col-md-3 col-sm-3 label-align"> Foto User <span class="required">*</span></label>
											<div class="col-md-6 col-sm-6 ">
