						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form method="post" action="<?php echo base_url('admin/tbl_pendidikan/AksiEdit')?>">
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align">ID PENDIDIKAN
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="id_pendidikan" class="form-control " value="<?php echo $tbl_pendidikan->id_pendidikan ?>" readonly>
											</div>
										</div>
										<div class="item form-group">
