						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form method="post" action="<?php echo base_url('admin/tbl_keluarga/AksiEdit')?>">
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align">ID KELUARGA
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="id_keluarga" class="form-control " value="<?php echo $tbl_keluarga->id_keluarga ?>" readonly>
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												<a href="<?php echo base_url('admin/tbl_keluarga')?>"><button class="btn btn-primary" type="button">Cancel</button></a>
