					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form method="post" action="<?php echo base_url('admin/tbl_jurusan/input_aksi')?>">
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align">ID JURUSAN
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="id_jurusan" class="form-control " placeholder="Kolom ini akan terisi otomatis" disabled>
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												<a href="<?php echo base_url('admin/tbl_jurusan')?>"><button class="btn btn-primary" type="button">Cancel</button></a>
