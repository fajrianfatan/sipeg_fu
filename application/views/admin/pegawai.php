                                ...
                                <div class="col-sm-12">
                                    <div class="card-box table-responsive">
                                        ...
                                        <p class="text-muted font-13 m-b-30">
                                            Catatan : Pastikan data pegawai terkelola dengan baik. Apabila anda
                                            menghapus data pegawai, maka seluruh data lainnya yang berkaitan dengan
                                            pegawai yang bersangkutan akan terhapus.
                                        </p>
                                        <a href="<?php echo base_url('admin/pegawai/input') ?>"><button
                                                class="btn btn-sm btn-primary">Tambah Pegawai</button></a>
                                        <table id="datatable-buttons"
                                            class="table table-striped table-bordered datatable-buttons"
                                            style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th>No</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="5%">
                                                        <img width="100%"
                                                            src="<?php echo base_url('assets/directory/foto pegawai/' . $peg->foto_pegawai); ?>">
                                                    </td>
                                                    <td><?php echo $peg->nip ?></td>
                                                    <td width="100%"><?php echo $peg->nama_pegawai ?>,
                                                        <?php echo $peg->gelar_pegawai ?></td>
                                                    ...
                                                    <td>
                                                        <a
                                                            href="<?php echo base_url('admin/pegawai/edit') ?>/<?php echo $peg->id_pegawai ?>">
                                                            <div class="btn btn-sm btn-primary">Ubah</div>
                                                        </a>
                                                        <a
                                                            href="<?php echo base_url('admin/pegawai/deletePegawai') ?>/<?php echo $peg->id_pegawai ?>">
