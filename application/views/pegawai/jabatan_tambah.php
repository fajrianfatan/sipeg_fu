...
<body class="nav-md">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								Masukkan data lampiran SK jabatan pegawai. Untuk menghindari error/gagal saat menambah dan mengunggah data lampiran SK jabatan pegawai baru, silakan unggah file SK jabatan dengan ukuran maksimal 2 MB dan format PDF.
								</p>
									<br />
									<?php echo form_open_multipart('pegawai/jabatan/input_aksi')?>
                                        <div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align">ID JABATAN
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="id_jabatan" class="form-control " placeholder="Kolom ini akan terisi otomatis" disabled>
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="tmtjbtn" name="tmt_sk_jabatan" class="date-picker form-control" placeholder="dd-mm-yyyy" type="text" required="required" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)">
												<script>
										...
										<div class="item form-group">
											<label for="email" class="col-form-label col-md-3 col-sm-3 label-align">Gaji Pokok Jabatan<span class="required">*</span></label>
											<div class="col-md-6 col-sm-6 ">
												<input required="required" name="gaji_pokok_jabatan" class="form-control" type="text" >
											</div>
										</div>
                                        <div class="item form-group">
											<label  class="col-form-label col-md-3 col-sm-3 label-align">Lampiran SK Jabatan <span class="required">*</span><br> File Scan PDF/Gambar</label>
											<div class="col-md-6 col-sm-6 ">
												<input  name="lampiran_sk_jabatan" class="form-control" type="file" >
											</div>
										</div>
	...
	<!-- FastClick -->
	<script src="<?php echo base_url();?>assets/vendors/fastclick/lib/fastclick.js"></script><!-- iCheck -->
