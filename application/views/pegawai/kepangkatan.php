            ...
            <div class="row">
              ...
              <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <a href="<?php echo base_url('pegawai/kepangkatan/input')?>"><button class="btn btn-sm btn-primary">Tambah SK Kepangkatan</button></a>
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="20%"><?php echo $pkt->nama_pegawai ?>, <?php echo $pkt->gelar_pegawai ?></td>
                          ...
                          <td width="30%"><a href="<?php echo base_url('pegawai/kepangkatan/edit')?>/<?php echo $pkt->id_kepangkatan ?>"><div class="btn btn-sm btn-primary" >Ubah</div></a>
                          ...
                          <a href="<?php echo base_url('pegawai/kepangkatan/deleteKepangkatan')?>/<?php echo $pkt->id_kepangkatan ?>"><div class="btn btn-sm btn-danger" >Hapus</div></td>
                        <?php endforeach;?>
                      </tbody>
                    </table>
                    </table>
