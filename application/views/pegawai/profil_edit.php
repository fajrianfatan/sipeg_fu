								...
								<div class="x_content">
									...
									<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input required="required" name="password" class="form-control" type="password" value="<?php echo $pegawai->password ?>">
											</div>
										</div>-->
										<div class="item form-group">
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align">Status Pegawai </label>
											<div class="col-md-6 col-sm-6 ">
												<input name="status_pegawai" class="form-control" type="text" value="<?php echo $pegawai->status_pegawai ?>" readonly>
											</div>
										</div>
										<div class="item form-group">
