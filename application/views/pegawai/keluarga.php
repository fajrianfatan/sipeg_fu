              ...
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <?php echo $this->session->flashdata('pesan')?>
                    ...
                    <a href="<?php echo base_url('pegawai/keluarga/input') ?>"><button class="btn btn-sm btn-primary">Tambah Data Keluarga</button></a>
                      ...
                      <tbody>
                        ...
                        foreach ($keluarga as $kel) : ?>
                          <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url('pegawai/keluarga/edit') ?>/<?php echo $kel->id_keluarga ?>"><div class="btn btn-sm btn-primary">Ubah</div></a>
                              <a href="<?php echo base_url('pegawai/keluarga/deleteKeluarga') ?>/<?php echo $kel->id_keluarga ?>"><div class="btn btn-sm btn-danger">Hapus</div></a>
                            </td>
                            <!-- <td width="20px"><a href="<?php echo base_url('pegawai/keluarga/edit') ?>/<?php echo $kel->id_keluarga ?>">
                                <div class="btn btn-sm btn-primary">Ubah</div><a href="<?php echo base_url('pegawai/keluarga/deleteKeluarga') ?>/<?php echo $kel->id_keluarga ?>">
