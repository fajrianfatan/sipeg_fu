...
class Keluarga extends CI_Controller {
	...
	public function index()
	{
		...
		$data = array(
			'keluarga' => $this->Keluarga_model->tampil_data_aspeg()->result(),
        ...
        $this->load->view('pegawai/keluarga',$data);
	}
	...
	public function input()
	{
		...
		$this->load->view('pegawai/keluarga_tambah',$dataInput);
	}
	...
	{	
		...
		redirect(base_url('pegawai/keluarga'));
	}
	...
	public function edit($id)
	{
		...
		$this->load->view('pegawai/keluarga_edit',$data);
	}
